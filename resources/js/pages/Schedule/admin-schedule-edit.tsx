...
export default function AdminScheduleEdit() {
    const { schedule } = usePage<SharedData & { schedule: Schedule }>().props;    const { data, setData, put, processing, errors } = useForm({
                ...
                <Card className="w-full max-w-4xl mt-6 bg-card shadow-lg border border-border">
                    <CardHeader>
                        <div className="flex justify-between items-start">
                            <div>
                                <CardTitle className="text-2xl text-foreground">Edit Schedule</CardTitle>
                            ...
                            <div className="flex gap-2">
                                <Link href={route('admin.schedule.show', schedule.id)}>
